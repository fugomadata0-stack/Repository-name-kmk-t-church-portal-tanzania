...
export function GradientKpiCard({ title, value, gradient }: { title: string; value: string | number; gradient: string }) {
  return (
    <article className="relative flex h-full min-h-[148px] flex-col items-center justify-center overflow-hidden rounded-2xl border border-slate-300/90 bg-white p-5 pt-6 text-center shadow-xl shadow-slate-900/12 transition-shadow duration-200 hover:shadow-2xl sm:min-h-[156px] sm:rounded-3xl sm:p-6 sm:pt-7">
