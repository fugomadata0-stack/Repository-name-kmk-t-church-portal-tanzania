...
export const ENTERPRISE_COMMAND_MODULES: EnterpriseCommandModule[] = [
  ...
  },
  {
    ...
    submodules: ["Sadaka", "Zaka", "Michango ya Kawaida", "Financial Reports", "Usambazaji & Remittance"],
  ...
  },
  {
    ...
    defaultSubmodule: "Print & PDF Master",
    submodules: ["Finance Reports", "Print & PDF Master", "KPI Executive (Ngazi)", "Ripoti Phase 1 (PDF)"],
  ...
  },
  {
    ...
    submodules: ["Enterprise RBAC", "Audit Logs", "Roles", "Sessions"],
